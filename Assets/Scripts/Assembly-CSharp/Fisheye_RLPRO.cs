...
public class Fisheye_RLPRO : ScriptableRendererFeature
{
	public class Fisheye_RLPROPass : ScriptableRenderPass
	{
		...
		private static readonly int cutoffXV;

		private static readonly int cutoffYV;

		private static readonly int cutoffFadeXV;

		private static readonly int cutoffFadeYV;

		private static readonly int fisheyeBendV;

		private static readonly int fisheyeSizeV;
